...
namespace LIB.util
{
    // TODO: check if exist simple schedule task without Task.Delay while 
    public class PeriodicTask
    {
        private readonly Dictionary<Action, CancellationTokenSource> _scheduledActions = new Dictionary<Action, CancellationTokenSource>();
        ...
        public void StopAll()
        {
            foreach (var a in _scheduledActions.Values)
            {
                a.Cancel();
            }
